...
class NinjaBuildExtension(BuildExtension):
    def __init__(self, *args, **kwargs) -> None:
        ...
        if not os.environ.get("MAX_JOBS"):
            ...
            max_jobs = max(1, min(max_num_jobs_cores, max_num_jobs_memory))//3*2  # use only 2/3 of the max jobs to be safe
            os.environ["MAX_JOBS"] = str(max_jobs)
            print("Setting MAX_JOBS environment variable to ", os.environ["MAX_JOBS"])
